...
export default function Navbar({ cartCount = 0, onLogoClick }) {
  return (
    <nav className="bg-white border-b border-gray-200 sticky top-0 z-50 p-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex items-center space-x-6 flex-shrink-0">
          ...
          {/* Shopping Cart Icon */}
          <button className="relative p-2 text-[#3E0202] hover:text-[#BA6FA9] transition-colors focus:outline-none">
